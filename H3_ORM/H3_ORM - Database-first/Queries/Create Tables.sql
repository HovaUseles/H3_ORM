...
CREATE TABLE Patrons_Books (
    ...
    CONSTRAINT FK_Books FOREIGN KEY (BookId) REFERENCES Books(BookId) ON DELETE CASCADE,
    CONSTRAINT FK_Patrons FOREIGN KEY (PatronId) REFERENCES Patrons(PersonId) ON DELETE CASCADE,
    CONSTRAINT PK_PatronsBookS PRIMARY KEY (BookId, PatronId)
);